 ...
 */
fun Fragment.existsFragmentByTag(tag: String) = activity?.supportFragmentManager?.findFragmentByTag(tag) != null

/**
 * Method to get fragment by tag. The operation is performed by the childFragmentManager.
 */
fun Fragment.findFragmentByTag(tag: String): Fragment? = activity?.supportFragmentManager?.findFragmentByTag(tag)